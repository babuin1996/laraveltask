            ...
            <div class="col-md-8">
                ...
                <form action="/users/update/{{$user->id}}" method="post">
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        <input type="checkbox" class="form-check-input" id="permCreate" value="1" name="permCreate" @if($user->perm_create == 1) checked @endif >
                        <label class="form-check-label" for="permCreate">Can create</label>
                    </div>


                    <div class="form-check form-check-inline">
                        <input type="checkbox" class="form-check-input" id="permRead" value="1" name="permRead" @if($user->perm_read == 1) checked @endif >
                        <label class="form-check-label" for="permRead">Can read</label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input type="checkbox" class="form-check-input" id="permUpdate" value="1" name="permUpdate" @if($user->perm_update == 1) checked @endif >
                        <label class="form-check-label" for="permUpdate">Can update</label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input type="checkbox" class="form-check-input" id="permDelete" value="1" name="permDelete" @if($user->perm_delete == 1) checked @endif >
